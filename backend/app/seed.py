...
def seed_database():
    ...
    if db.query(RewardRule).count() == 0:
        rules = [
            # Individual
            RewardRule(waste_type="Paper & Cardboard", user_type="Individual", rate_per_kg=25.0, penalty_flat_rate=0.0),
            RewardRule(waste_type="Recyclable Metals & Cans", user_type="Individual", rate_per_kg=50.0, penalty_flat_rate=0.0),
            RewardRule(waste_type="Clean Plastic Packaging", user_type="Individual", rate_per_kg=100.0, penalty_flat_rate=0.0),
            RewardRule(waste_type="Contaminated Waste", user_type="Individual", rate_per_kg=0.0, penalty_flat_rate=15.0),
            # Commercial
            RewardRule(waste_type="Paper & Cardboard", user_type="Commercial", rate_per_kg=20.0, penalty_flat_rate=0.0),
            RewardRule(waste_type="Recyclable Metals & Cans", user_type="Commercial", rate_per_kg=40.0, penalty_flat_rate=0.0),
            RewardRule(waste_type="Clean Plastic Packaging", user_type="Commercial", rate_per_kg=80.0, penalty_flat_rate=0.0),
    ...
    records = [
        # Aarav Sharma records
        {
            ...
            "feedback": "Flawlessly sorted paper cartons and cardboard boxes.",
            "amount": 75.0,
            "breakdown": "3.00 kg × 25.00 GP/kg = +75 GP",
        },
        {
            "user": aarav_user,
            "ward": ward_map["Koramangala"],
            "code": "GP-BLR-2025-10084",
            "type": "Recyclable Metals & Cans",
            "kg": 4.0,
            "days_ago": 3,
            "status": "Processed",
            "stage": "Recycling/Disposal",
            "feedback": "Clean aluminum beverage cans and tins.",
            "amount": 200.0,
            "breakdown": "4.00 kg × 50.00 GP/kg = +200 GP",
        },
        {
            "user": aarav_user,
            "ward": ward_map["Koramangala"],
            ...
            "amount": 62.5,
            "breakdown": "2.50 kg × 25.00 GP/kg = +62.5 GP",
        },
        {
            "user": aarav_user,
            "ward": ward_map["Koramangala"],
            "code": "GP-BLR-2025-09820",
            "type": "Clean Plastic Packaging",
            "kg": 4.5,
            "days_ago": 10,
            "status": "Claimed",
            "stage": "Processing",
            "feedback": "Sorted PET bottles and clean dry plastic wrappers.",
            "amount": 450.0,
            "breakdown": "4.50 kg × 100.00 GP/kg = +450 GP",
        },
        {
            "user": aarav_user,
            "ward": ward_map["Koramangala"],
        ...
        # Priya Nair records
        {
            ...
            "status": "Processed",
            "stage": "Recycling/Disposal",
            "feedback": "Exemplary dry segregation. Corrugated cartons and newspapers.",
            "amount": 125.0,
            "breakdown": "5.00 kg × 25.00 GP/kg = +125 GP",
        },
        {
            "user": priya_user,
            "ward": ward_map["Indiranagar"],
            ...
            "status": "Processed",
            "stage": "Recycling/Disposal",
            "feedback": "Bulk clean plastic packaging, bottles, and chips wrappers.",
            "amount": 350.0,
            "breakdown": "3.50 kg × 100.00 GP/kg = +350 GP",
        },
        # Rajesh Kumar records (has anomaly)
        {
            ...
            "status": "Pending",
            "stage": "Collection",
            "feedback": "High volume dry cardboard recorded during home renovation cleanup.",
            "amount": 2125.0,
            "breakdown": "85.00 kg × 25.00 GP/kg = +2125 GP",
            "has_anomaly": True,
        },
        # Cafe Commercial records
        {
            ...
            "status": "Processed",
            "stage": "Recycling/Disposal",
            "feedback": "Bulk commercial clean plastic packaging and wrappers.",
            "amount": 3360.0,
            "breakdown": "42.00 kg × 80.00 GP/kg = +3360 GP",
        },
        {
            "user": cafe_user,
            "ward": ward_map["Koramangala"],
            ...
            "status": "Processed",
            "stage": "Recycling/Disposal",
            "feedback": "Commercial beverage metal cans and tins.",
            "amount": 720.0,
            "breakdown": "18.00 kg × 40.00 GP/kg = +720 GP",
        },
    ]
    ...
    notifs = [
        Notification(
            ...
            title="Reward Credited: +75 GP",
            message="Your dry recyclable waste collection (3.0 kg) was verified by Supervisor Ramesh Rao. 75 Green Points have been credited to your GreenPay Wallet.",
            type="REWARD",
            is_read=False,
    ...
    audit_events = [
        ...
        AuditLog(
            ...
            new_state='{"transaction_id": "GP-BLR-2025-10112", "weight_kg": 3.0, "waste_type": "Paper & Cardboard", "reward": 75.0}',
